...
/**
 * @author joy joe
 * @date 2021/12/21 下午1:03
 * @DESC TODO
 */
public class PicCombineUtils {
    /**
     * 合并两个图片
     *
     ...
     * @param maxBorder  true:取两图最大边框;false:以图片1尺寸和坐标为准
     * @return
     * @throws IOException
     */
    public static boolean mergeImages(String img1Path, String img2Path,
        ...
        if (StringUtils.isNotEmpty(img1Path) && StringUtils.isNotBlank(img2Path)) {
    ...
    public static void main(String[] args) throws IOException {
        String IMAGE_PATH = "/Users/jobstribe/Desktop/";
        String img1Path = IMAGE_PATH + "14151640058137_.pic.jpg";

        String img2Path = IMAGE_PATH + "14141640058113_.pic.jpg";
        ...
        mergeImages(img1Path, img2Path, x, y, destPath1, "jpg", maxBorder);

        maxBorder = true;//取最大边框
        mergeImages(img1Path, img2Path, x, y, destPath2, "jpg", maxBorder);
    }
